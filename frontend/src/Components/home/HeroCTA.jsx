  ...
  <section className="bg-hero-cta p-4">
   <Container>
    <Row className="align-items-center gx-2">
     ...
     <Col md={6}>
      <h1 className="color-text-hero h3 mt-4 mb-2 text-uppercase">
       THE DROP MARKETPLACE
      </h1>
      <p className="color-text-hero mb-0">
     ...
     <Col md={4} className="d-flex justify-content-md-end gap-3 mt-3 mt-md-0">
      <Button
       ...
       to="/catalog"
       size="lg"
       className="button-cta-hero button-cta-hero_primary rounded-pill px-6"
      >
       Comprar
      </Button>
      <Button
